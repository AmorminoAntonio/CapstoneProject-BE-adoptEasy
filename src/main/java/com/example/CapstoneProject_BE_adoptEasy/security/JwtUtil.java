...
import com.example.CapstoneProject_BE_adoptEasy.exception.CreateTokenException;
...
public class JwtUtil {
    ...
    public String creaToken(Utente utente){
        ...
        claims.put("roles", utente.getRole());
        claims.put("firstname", utente.getFirstName());
        claims.put("lastname", utente.getLastName());
